...
import { Plus, RefreshCw, Loader2, FileText, ArrowUpCircle, ArrowDownCircle, Wallet } from "lucide-react";
...
export default function UangSakuPage() {
  ...
  }, [page, limit, filterStatusUangSaku, filterStatus, searchQuery]);
    ...
    try {
      ...
      const response = await fetch("/api/transaksi", {
        ...
        body: JSON.stringify({
          ...
          statusUangSaku: formData.statusUangSaku,
  ...
  const columns = getTransaksiColumns("UANG_SAKU", {
  ...
  return (
    <div className="flex flex-col gap-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Transaksi Uang Saku</h1>
          <p className="text-muted-foreground">
            Kelola uang saku santri (setoran & penarikan)
          </p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-orange-600">{formatCurrency(totalDiambil)}</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <div className="py-4">
            ...
            {selectedTransaksi && (
              <div className="mt-2 p-3 bg-muted rounded-md text-sm">
                ...
                <p><strong>Jenis:</strong> {selectedTransaksi.statusUangSaku}</p>
