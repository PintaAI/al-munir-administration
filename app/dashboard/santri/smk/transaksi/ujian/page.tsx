        ...
        <CardContent>
          <div className="space-y-4">
            {[
              ...
              { subject: "Produktif TKJ", date: "28 Mar 2026", time: "08:00 - 11:00", room: "Lab Komputer 1", type: "Praktik" },
            ].map((item, index) => (
        ...
        <CardContent>
          <div className="space-y-4">
            {[
              ...
              { subject: "Produktif TKJ", score: 90, date: "12 Feb 2026", type: "Praktik" },
              { subject: "PKN", score: 85, date: "11 Feb 2026", type: "Ujian Harian" },
              { subject: "Agama", score: 92, date: "10 Feb 2026", type: "Ujian Harian" },
              { subject: "Fisika", score: 78, date: "09 Feb 2026", type: "Ujian Harian" },
              { subject: "Kimia", score: 80, date: "08 Feb 2026", type: "Ujian Harian" },
            ].map((item, index) => (
              <div key={index} className="flex items-center justify-between p-4 border rounded-lg">
                <div className="flex items-center gap-4">
