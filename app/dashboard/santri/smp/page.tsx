...
import { Receipt, Wallet, Shirt, FileCheck, BookOpen, BookMarked, User, GraduationCap, FileText } from "lucide-react"

export default function SantriSMPPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Dashboard Santri SMP</h1>
        <p className="text-muted-foreground">Selamat datang di panel santri SMP</p>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Link href="/dashboard/santri/smp/transaksi/spp">
          ...
          <Link href="/dashboard/santri/smp/transaksi/syahriah">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer h-full">
              <CardHeader>
                <div className="flex items-center gap-3">
          ...
          <Link href="/dashboard/santri/smp/transaksi/uang-saku">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer h-full">
              <CardHeader>
                <div className="flex items-center gap-3">
          ...
          <Link href="/dashboard/santri/smp/transaksi/laundry">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer h-full">
              <CardHeader>
                <div className="flex items-center gap-3">
          ...
          <Link href="/dashboard/santri/smp/transaksi/ujian">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer h-full">
              <CardHeader>
                <div className="flex items-center gap-3">
          ...
          <Link href="/dashboard/santri/smp/transaksi/tka">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer h-full">
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-lg">TKA</CardTitle>
                    <CardDescription>Program Tahfidz & Kitab</CardDescription>
                  </div>
                </div>
              </CardHeader>
            </Card>
          ...
          <Link href="/dashboard/santri/smp/transaksi/buku-pendamping">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer h-full">
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-lg">Buku Pendamping</CardTitle>
                    <CardDescription>Buku pendamping pembelajaran</CardDescription>
                  </div>
                </div>
              </CardHeader>
            </Card>
          ...
          <Link href="/dashboard/santri/smp/profil">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer h-full">
              <CardHeader>
                <div className="flex items-center gap-3">
          ...
          <Link href="/dashboard/santri/smp/akademik">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer h-full">
              <CardHeader>
                <div className="flex items-center gap-3">
