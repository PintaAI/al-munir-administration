...
import { Receipt, Wallet, Shirt, FileCheck, Briefcase, Trophy, CheckCircle2, Clock, XCircle, ArrowDown, ArrowUp, Loader2 } from "lucide-react"
...
> = {
  ...
  pkl: { title: "PKL", icon: <Briefcase className="h-5 w-5" />, color: "indigo" },
  lks: { title: "LKS", icon: <Trophy className="h-5 w-5" />, color: "orange" },
}
